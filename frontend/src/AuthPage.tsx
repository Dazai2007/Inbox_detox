          ...
          <div className="form-wrapper relative w-full h-auto"> 
            ...
            >
              ...
              <p className="text-center text-gray-600 text-sm"> 
                Don't have an account? <span onClick={() => { setTab('register'); setError(null); }} className="text-blue-600 hover:underline cursor-pointer">Create one</span>
              </p>
            </form>
            ...
            >
              ...
              <p className="text-center text-gray-600 text-sm"> 
                Already have an account? <span onClick={() => { setTab('login'); setError(null); }} className="text-blue-600 hover:underline cursor-pointer">Sign In</span>
              </p>
            </form>
          </div>
        </div>
